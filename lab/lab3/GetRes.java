...
public class GetRes {
	...
	public static class GetRes extends Mapper <Object, Text, Text, Text> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			Text valueInfo = new Text(String.valueOf(cid));
	...
	public static void main(String[] args) throws Exception {
		...
		String centerPath = "cluster/iter4/part-r-00000";
		conf.set("centerPath", centerPath);
		Job job = Job.getInstance(conf, "get result");

		job.setJarByClass(GetRes.class);
		
		job.setMapperClass(GetResMapper.class);
